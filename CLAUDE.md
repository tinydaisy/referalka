...
### Платёжная система клиента: LeadPay + Продамус (миграции 257, 269 от 2026-08-07)
...
**Поля** (`clients`): `pay_provider` (`leadpay|prodamus|NULL`), `pay_leadpay_login`/`pay_leadpay_token`, `pay_prodamus_url`/`pay_prodamus_secret` (миграция 269).
