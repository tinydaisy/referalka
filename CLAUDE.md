...
### Архитектура Mini App (зафиксировано 2026-04-27)

**Принцип:** двухуровневая навигация — **Хаб организатора** (общая визитка клиента) и **Экран события** (конкретное мероприятие).

**Контекст входа** определяет, какой уровень открывается первым:
- `/start` без параметров → Хаб
- `?startapp=ref_pg{slug}...` → сразу Экран события (с этим slug)

#### Уровень 1 — Хаб организатора
