...
⚠️⚠️ **ВЫБОР АНКЕТЫ ИЗ БЛОКА УБИРАЕТСЯ** (07.09.2026, ⚠️ ещё не сделано). Анкета берётся из **формы заявки** владельца лендинга; в блоке остаются только заголовок, подзаголовок и оформление + приписка «форма заявки подтянется автоматически». Два места, задающих одно и то же, неминуемо разъедутся: клиент поменял анкету в форме заявки, а на лендинге осталась старая. Настройка живёт в разделе **«Платежи/Заявки»** → вкладка «Формы заявки», **одна форма на владельца** (кнопка участия одна — при двух формах непонятно, какую открывать; разные наборы вопросов это разные анкеты, их и так сколько угодно).
