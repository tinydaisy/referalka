...
|---|---|---|
| **`998700388279`** — рабочий, единственный | нет | ✅ работает |
...
⚠️⚠️ **АККАУНТ ОДИН — `998700388279` (@margo_co8992)** (решение владельца 07.09.2026). Другие узбекские номера в услуге НЕ использовать и в `tg_setup_accounts` не заводить, даже если они проверены и чисты.
