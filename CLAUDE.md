...
**⚠️ Email главнее телефона.** Если email принадлежит одному контакту, а телефон другому — победит контакт по email, телефон второго проигнорируется (второй контакт останется отдельной записью). Автоматически их НЕ сливаем: слияние живых людей по одному совпавшему полю опаснее дубля. Ручное слияние — кнопка «Объединить» в карточке контакта.
