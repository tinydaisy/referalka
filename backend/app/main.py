...
app.include_router(partner.public_router)                          # /partner/{client_id}, /r/partner/{run_id} (миграция 105)
app.include_router(partner.api_router, prefix="/api/v1")           # /api/v1/partner/runs/{run_id}
