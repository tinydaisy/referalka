    ...
    if not found:
        ...
        return RedirectResponse(
            f"{back}?ig_error=" + _up.quote(
                ...
                f"ни к одной из них. Откройте приложение Instagram → Настройки → "
                f"«Учётный аккаунт» → «Центр аккаунтов» и проверьте, какая страница "
                f"связана с аккаунтом. Если связи нет — добавьте её там же. "
                f"Аккаунт должен быть Бизнес или Автор."
            ),
            status_code=302,
        )
