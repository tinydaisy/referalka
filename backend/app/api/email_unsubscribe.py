...
<body>
  <div class="card">
    <h1>Не получилось открыть отписку</h1>
    <p>Похоже, ссылка скопирована не целиком — она длинная, и почтовые
       программы часто разрывают её на две строки.</p>
    <p><b>Что делать:</b> вернитесь в письмо и нажмите на ссылку мышкой,
       а не копируйте её вручную.</p>
    <p style="margin-top:18px;font-size:13px;">Если не помогло — ответьте на
       письмо, и вас отпишут вручную. Отписка точно сработает.</p>
  </div>
</body>
</html>
"""
