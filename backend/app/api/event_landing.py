...
LIVE_KINDS = {"speakers", "partners", "program", "tariffs", "organizer",
              ...
              # ⚠️ `venue` — живой: адрес приходит из `events.address`, того же
              # поля, что показывается в Mini App и в боте. Держать адрес ещё и
              # в блоке значило бы править его в двух местах, и на карте
              # оказался бы старый.
              "venue",
