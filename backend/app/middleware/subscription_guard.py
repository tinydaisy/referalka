...
PASSTHROUGH_PREFIXES = (
    ...
    "/api/v1/addons/",
    "/api/v1/referrals/",
    # ⚠️ Новости платформы открыты и при замороженном кабинете. Отметка
    # «прочитано» и «скрыть все» — это POST, то есть запись: под заморозкой
    # клиент не смог бы ни закрыть плашку, ни погасить колокольчик, и плашка
    # висела бы вечно. Ровно этому человеку новость про продление и нужна.
    "/api/v1/news/",
    "/api/v1/platform-news",
