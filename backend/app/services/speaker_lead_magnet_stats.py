...
⚠️ ТРИ ПЕРИОДА РЯДОМ (решение владельца): до окончания события, «+3 дня» и
«+7 дней» после него. Начало у всех ОДНО — первый день события. Смысл в том,
чтобы видеть, сколько людей добирает подарок уже после события: по одной
...
# Хвосты после окончания события: 0 = ровно до последнего дня программы.
# Порядок важен — в таком виде и показываем.
TAIL_DAYS = (0, 3, 7)
