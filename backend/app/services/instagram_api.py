...
# Разрешения, которые запрашиваем у клиента.
#
...
# затягивают одобрение. Плюс это прямой ответ на вопрос клиента «что вы
# получаете о моём аккаунте»: чем короче список, тем честнее ответ.
#
...
def is_configured() -> bool:
    ...
    return bool(settings.ig_app_id and settings.ig_app_secret)
