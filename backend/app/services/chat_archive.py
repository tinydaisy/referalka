...
DEFAULT_CHAT_GREETINGS = [
    "Здравствуйте! Располагайтесь и знакомьтесь! Увидели в закрепе навигацию?",
    ...
    "Здравствуйте! Рады вам! Есть задачи, под которые нужны ресурсы? У нас тут много людей с сильной экспертизой",
    "Здравствуйте! Располагайтесь. Что сейчас актуальнее? Клиенты, партнерства, ресурсы? Сориентируем",
    "Здравствуйте! Рады вам! Поделитесь, что именно привлекло на мероприятие?",
