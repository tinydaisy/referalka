  ...
  return (
    <div className="pb-24 max-w-3xl">
      ...
      <Section step="7.5" title="⚠️ ГЛАВНОЕ: включить приложение «для всех» (иначе ссылки не откроются)">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 text-sm text-amber-900">
          💡 Если ВК просит пройти <strong>модерацию</strong> перед публикацией — пройдите её (обычно
          проверяют название, иконку и что приложение открывается). До прохождения модерации приложение
          остаётся доступным «только администраторам».
        </div>
      </Section>
