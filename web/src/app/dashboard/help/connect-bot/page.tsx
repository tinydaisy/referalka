...
export default function ConnectBotInstructionPage() {
  ...
  return (
    <div className="pb-24 max-w-3xl">
      ...
      {/* ⚠️ Зачем вообще Mini App — главный смысл для клиента. Стоит ДО
          технических шагов: без него инструкция читается как «ещё одна
          настройка», а это ключевое отличие платформы. */}
      <div className="rounded-xl border p-5 mb-6" style={{ background: 'rgba(255,207,164,0.15)', borderColor: PEACH }}>
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          ...
          становится подписчиком вашего бота</b>, ничего для этого не делая специально.
          При этом он видит удобный интерфейс события: программу, спикеров, подарки,
          чат — а не форму, которую надо заполнить, чтобы хоть что-то посмотреть.
        </p>
