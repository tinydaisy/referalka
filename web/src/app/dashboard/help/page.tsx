...
const ARTICLES: Article[] = [
  ...
  {
    href: '/dashboard/help/landing-widgets',
    title: 'Виджеты для своего лендинга (спикеры, программа)',
    description: 'Подтягивайте данные спикеров/жюри/организаторов/партнёров и программу события на свой лендинг (Tilda, GetCourse, AI-сайт на Vercel) через 2 публичных JSON-эндпоинта. При изменении в ПЛЮСОНе лендинг обновится сам в течение минуты',
    emoji: '🧩',
  },
  {
    href: '/docs/api',
