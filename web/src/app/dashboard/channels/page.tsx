  ...
  return (
    <div className="p-6 max-w-5xl">
      ...
      {/* Юридическая сноска про Meta.
          ...
          ⚠️ ТОЛЬКО на вкладке «Боты»: там живёт секция Instagram. На «Группах
          для рассылок» и «Автонастройке» Instagram не упоминается вовсе, и
          сноска про него висела внизу как случайный текст. */}
      {tab === 'bots' && (me?.features || []).includes('instagram_funnel') && (
  ...
  return (
    <div className="space-y-6">
      ...
      {Object.entries(otherBySlug).map(([slug, chs]) => {
         ...
         * неясно, уходят ли через него письма клиента вообще. Уходят — но
         * СЛУЖЕБНЫЕ: о регистрации, заказах, оплатах, выдаче доступов.
         *
         * ⚠️ РАССЫЛОК ПО БАЗЕ ЧЕРЕЗ НЕГО НЕТ. Они гейтятся отдельной фичей
         * `email_broadcasts` (проверка в tasks/broadcast.py), и у обычного
         * клиента их нет вовсе. Писать «через этот канал уходят рассылки» —
         * прямая неправда, за которой человек пойдёт искать несуществующую
         * возможность.
         *
              ...
              <div className="rounded-xl border border-emerald-200 bg-emerald-50/60 px-5 py-4">
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="text-sm">
                    ...
                    {/* ⚠️ Здесь про рассылки писать можно: свой почтовый домен
                        и фича `email_broadcasts` живут в одном тарифе (Экстра и
                        выше), то есть у клиента с доменом рассылки есть. */}
                    <p className="text-gray-600 mt-1 leading-relaxed">
                      Письма уходят с вашего адреса, а не с нашего: email-рассылки
                      по вашей базе, письма о регистрации на события и эфиры,
                      о заказах и оплатах, уведомления рефералов о переходах по их
                      ссылкам, выдача доступов к продуктам и услугам.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <>
                ...
                {isEmail && (
                  <div className="rounded-xl border border-gray-200 bg-gray-50 px-5 py-4 mt-2 text-sm">
                    {/* ⚠️ РАССЫЛКИ ПО БАЗЕ ЧЕРЕЗ СИСТЕМНЫЙ КАНАЛ НЕ ИДУТ.
                        Здесь стояло «через этот канал уходят рассылки по базе» —
                        это неправда: email-рассылки гейтятся фичей
                        `email_broadcasts` (только Экстра и выше), см. проверку
                        в tasks/broadcast.py. Системный канал шлёт СЛУЖЕБНЫЕ
                        письма — те, что платформа отправляет сама по событию. */}
                    <p className="text-gray-700">
                      Через этот канал уходят письма о регистрации на события и эфиры,
                      письма о заказах и оплатах, уведомления рефералов о переходе
                      людей по их ссылкам, выдача доступов к вашим продуктам и
                      услугам — но с общего адреса{' '}
                      <span className="font-mono">noreply@pluson.ru</span>, не с вашего.
                      Но с указанием вашего имени и бренда.
                    </p>
                    ...
                    <p className="text-gray-600 mt-2">
                      Хотите делать email-рассылки по своей базе или чтобы письма
                      приходили с вашего домена —{' '}
