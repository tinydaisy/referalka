  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <Card title="Кому платить вознаграждение">
        <div className="space-y-2">
          {/* ⚠️ Названия режимов — «Пассивный» и «Активный» (слова владельца).
              Само по себе слово ничего не объясняет и читается двусмысленно
              («активный» = включённый?), поэтому рядом ВСЕГДА идёт строка,
              что оно значит. Убирать её нельзя. */}
          <Radio
            checked={isPassive}
            onChange={() => set('partner_payout_mode', 'passive')}
            title="Пассивный — закреплённому партнёру со всех покупок человека"
          ...
          <Radio
            ...
            title="Активный — тому, кто привёл на эту покупку"
      ...
      {/* ⚠️ Уровни существуют ТОЛЬКО в пассивном режиме. В активном на покупке
