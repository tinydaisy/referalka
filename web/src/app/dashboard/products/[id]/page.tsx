  ...
  return (
    <div className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
      ...
      <div className="space-y-3">
        ...
        {/* ⚠️⚠️ Поле «Код товара» УБРАНО (решение владельца 15.09.2026, после
            живой оплаты через v2). Карточки товара не нужны ни одной системе:
            LeadPay принимает название и цену в запросе, если в его кабинете
            один раз выбраны «Настройки → Варианты оплаты». Значения очищены
            у всех тарифов (снимок — таблица `_bak_pay_product_id_20260915`).

            ⚠️ Состояние `payProductId` оставлено НАМЕРЕННО: оно шлёт NULL при
            сохранении. Убрать его — значит перестать передавать поле вовсе, и
            у старой записи код молча ожил бы при следующей правке тарифа. */}
