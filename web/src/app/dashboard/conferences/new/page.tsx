...
import { ArrowLeft, Mic, Trophy } from 'lucide-react'
...
export default function NewConferencePage() {
  ...
  const pageTitle = isTournament ? 'Новый турнир' : t.conferences.new.title
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    try {
      const res = await api.events.create({ title: title.trim(), module_slug: moduleSlug })
