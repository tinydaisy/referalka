          ...
          <div key={s.key} className="border rounded-xl mb-2.5 overflow-hidden"
            ...
            {isOpen && (
              <div className="px-4 pb-3 pt-1 bg-white">
                {/* Ссылка-материал, которую видит жюри (video_url || video_folder_url) */}
...
function SnapshotView({ snap, onClose }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto p-5 scroll-visible" onClick={(e) => e.stopPropagation()}>
