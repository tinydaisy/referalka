  ...
  async function saveProfile(e: React.FormEvent) {
    ...
    try {
      ...
      await api.collaborators.update(profile.id, {
        ...
        crop_dx_circle: profile.crop_dx_circle ?? null,
        crop_dy_circle: profile.crop_dy_circle ?? null,
        crop_dx_square: profile.crop_dx_square ?? null,
        crop_dy_square: profile.crop_dy_square ?? null,
        crop_dx_portrait: profile.crop_dx_portrait ?? null,
        crop_dy_portrait: profile.crop_dy_portrait ?? null,
