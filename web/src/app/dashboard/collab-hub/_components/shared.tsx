          ...
          {form.is_published_in_hub ? (
            <>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium border"
                    style={{ background: '#E7F6EC', color: '#1B7F4C', borderColor: '#BFE6CD' }}>
                <span className="inline-block w-1.5 h-1.5 rounded-full" style={{ background: '#1B7F4C' }} />
                Опубликована в каталоге
              </span>
              <button type="button"
                onClick={() => setForm((f: any) => ({ ...f, is_published_in_hub: false }))}
