...
function Section({
  ...
  const title = block.kind === 'hero'
    ...
    : block.kind === 'description'
      ...
      // ⚠️ То же и у карты: «Как нас найти». Запасной заголовок нужен ИМЕННО
      // здесь, а не только при создании блока, — иначе у лендингов, собранных
      // до этой правки, секция осталась бы без подписи: там в базе пусто.
      : block.kind === 'venue'
        ? (block.title || 'Как нас найти')
