...
function BlockBody({
  ...
  switch (block.kind) {
    ...
    case 'numbers': {
      ...
      return (
        {/* Своя сетка, не lp-grid: цифры узкие, на телефоне их помещается
            2-3 в ряд. auto-fit сам решает, сколько влезло; настройка колонок
            остаётся потолком для широкого экрана. */}
        <div
