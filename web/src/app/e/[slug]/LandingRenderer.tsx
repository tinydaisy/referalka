...
export default function LandingRenderer({
  ...
  const rootBg: React.CSSProperties = page.bg_image_url
    // ⚠️ Под картинкой всё равно держим цветной фон. Картинка весит сотни
    // килобайт: пока она грузится (или не загрузилась вовсе), страница
    // оставалась БЕЛОЙ — а текст на ней светлый, и читать было нечего.
    ? { background: page.bg_css_screen || page.bg_css || page.bg_color || '#25455D' }
    : bgMode === 'block'
