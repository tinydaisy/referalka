...
export default function OrderForm({
  ...
  // ⚠️⚠️ ПЛАШКА ПОЛУПРОЗРАЧНАЯ (.18), а не заливка. При .85 она выглядела
  // сплошным персиковым прямоугольником и читалась как вторая кнопка над
  // настоящей — ровно то, от чего уходили с красной плашки.
  // ⚠️ Текст при такой прозрачности — светлый акцентный, а НЕ тёмно-синий:
  // синий на просвечивающем тёмном фоне не читается вовсе.
  const hintBg = (() => {
  ...
  const hintFg = page.border_color || page.color_heading || '#FFCFA4'
