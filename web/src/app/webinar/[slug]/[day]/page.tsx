      ...
      if (Hls.isSupported()) {
        ...
        const mk = () => {
          ...
          const h = new Hls({
            ...
            //
            // 10 секунд — половина плейлиста: плеер успевает набрать запас и
            // перестаёт голодать. Больше ставить нельзя, пока плейлист короткий:
            // сервер физически не отдаст того, чего в нём нет.
