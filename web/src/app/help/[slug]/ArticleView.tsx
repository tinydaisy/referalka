...
const ARTICLES: Record<string, React.ComponentType> = {
  ...
  'getcourse-partner': dynamic(() => import('../../dashboard/help/getcourse-partner/page'), { loading: Loading }),
  'getcourse-register': dynamic(() => import('../../dashboard/help/getcourse-register/page'), { loading: Loading }),
  'getting-started': dynamic(() => import('../../dashboard/help/getting-started/page'), { loading: Loading }),
  'landing-widgets-people': dynamic(() => import('../../dashboard/help/landing-widgets-people/page'), { loading: Loading }),
  'landing-widgets-program': dynamic(() => import('../../dashboard/help/landing-widgets-program/page'), { loading: Loading }),
  ...
  'participants-export': dynamic(() => import('../../dashboard/help/participants-export/page'), { loading: Loading }),
  'participants-tg-ai': dynamic(() => import('../../dashboard/help/participants-tg-ai/page'), { loading: Loading }),
