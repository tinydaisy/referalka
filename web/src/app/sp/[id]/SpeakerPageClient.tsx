    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-5 sm:px-8 py-8 sm:py-12 space-y-8">
        ...
        {/* ⚠️ Заголовок «Биография», а не «О спикере»: раздел выше теперь и так
            ...
            читались как повтор.
            ⚠️⚠️ Комментарий стоит ЗДЕСЬ, а не первой строкой внутри условия
            вывода — там он роняет сборку всей ветки: после «&& (» ожидается
            один родительский тег, а комментарий им не является. */}
        {data.bio && (
