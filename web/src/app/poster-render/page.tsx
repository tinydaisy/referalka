...
import PosterRenderClient from './PosterRenderClient'

/**
 * Страница отрисовки афиши — её открывает Chromium на сервере и снимает
 ...
 * запасной шрифт — а на афише шрифт заголовка виден крупнее всего.
 */
