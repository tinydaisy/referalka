...
function Screen() {
  ...
  useEffect(() => { setOffset(0) }, [specId, q])
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      ...
      if (specId !== null) sp.set('spec_id', String(specId))
  ...
  function pickSpec(v: number | null) {
    setSpecId(v)
    router.replace(v ? `/admin/tech/clients?spec=${v}` : '/admin/tech/clients')
  }
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900">Клиенты внедренцев</h1>
