...
type UploadKind = 'event_poster' | 'certificate' | 'referral_material' | 'lead_magnet' | 'speaker_photo' | 'speaker_poster' | 'brand_photo' | 'brand_logo' | 'owner_photo' | 'funnel_media' | 'broadcast_photo' | 'event_video' | 'speaker_video'
