...
/**
 * Настройки → «Стили бренда и лендинга» — фирменное оформление по умолчанию (миграция 241).
 *
        ...
        <div className="space-y-6">
          ...
          <Card title="Границы и иконки">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <ColorField label="Цвет иконок и кнопок обратной связи"
                value={theme.icon_color}
                onChange={v => set({ icon_color: v })}
                hint="Кнопки обратной связи (Telegram, ВКонтакте, MAX в блоке «Есть вопросы?») — это способы связи, а не призыв к действию. Они красятся этим цветом." />
            </div>
            <div className="mt-4 space-y-3 border-t border-gray-100 pt-4">
