...
export default function SolutionsTab() {
  ...
  return (
    <div>
      {/* ⚠️ Раздел открыт всем (миграция 412), но ещё дорабатывается — и мы
          говорим об этом честно ПЕРВОЙ строкой. Скрывать его дальше смысла
          не было: человек после автонастройки остаётся с пустым кабинетом,
          и каталог с шероховатостями полезнее, чем его отсутствие. Плашка
          заодно приглашает писать о неудобствах — это и есть обкатка. */}
      <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
        <p className="text-sm text-amber-900 leading-relaxed">
          <b>Раздел в разработке.</b> Мы продолжаем его дорабатывать, чтобы вам
          было удобно. Если что-то не получается или работает не так, как
          ожидали, — <Link href="/dashboard/help"
            className="font-medium underline">напишите нам</Link>, поможем и
          поправим. Поэтому мы принимаем любые ваши пожелания — и по разделу
          «Готовые решения», и по платформе в целом: расскажите, чего вам не
          хватает, и мы это учтём.
        </p>
      </div>
