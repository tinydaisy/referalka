  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* ⚠️⚠️ НА АФИШЕ СПИКЕРА ЗАГОЛОВКА ЗДЕСЬ НЕТ. Название конференции
            печатает её собственный блок — со своим полем, размером, цветом и
            положением (подвкладка «Название конфы»). Рисовать ещё и общий
            заголовок значит печатать название ДВАЖДЫ: именно это владелец
            видел на афише и просил убрать. */}
        {kind !== 'individual' && L.show_title !== false && !!titleText && (
          <Heading
            text={titleText}
