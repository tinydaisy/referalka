  ...
  return (
    <div className="space-y-4">
      ...
      {/* ⚠️ Ширина ограничена, а не «во всю страницу» (26.09.2026). Сначала
          ...
          ⚠️⚠️ Комментарий стоит ВЫШЕ условия, а не внутри `&& (`: в позиции
          сразу после `&& (` JSX ждёт ЭЛЕМЕНТ, и комментарий там роняет
          сборку — ловушка №1 из памятки проекта, на ней ушло четыре
          сборки. */}
      {covers.length > 0 && (
