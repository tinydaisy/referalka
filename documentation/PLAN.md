...
**Автоматические рассылки по тайм-слотам:**
- [ ] За 5 минут до начала выступления → «Через 5 минут стартует [Имя спикера] с темой [тема]! 🔥»
- [ ] В конце выступления (за 10 минут до следующего или по окончании) → «[Имя спикера] дарит подарок: [название] → [ссылка]»
- [ ] Утром дня конференции → напоминание о программе дня
- [ ] Все шаблоны редактируемые в веб-кабинете, с дефолтными значениями

**Настройка рассылок в веб-кабинете:**
- [ ] Список всех запланированных рассылок (дата, время, тип, статус: черновик / запланирована / отправлена / отменена)
- [ ] Редактирование текста каждого сообщения
