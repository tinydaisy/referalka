...
**Дашборд клиента:**
- [ ] Страница `/dashboard/profile` — две секции:
  - «Визитка» — фото, имя, позиционирование, регалии, соцсети
  - «Продукты и материалы» — список offerings с переключателем платно/бесплатно
- [ ] Пункт «Профиль» в сайдбаре под «Настройками»
