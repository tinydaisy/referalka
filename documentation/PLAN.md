...
## Автонастройка Telegram «под ключ» — услуга 790 ₽ (миграция 364, 2026-09-07) ⚠️ НЕ НА ПРОДЕ
...
- [ ] **Накатить на прод** и завести аккаунт `998700388279` (вывести его из мейлера!)
- [ ] Прописать `TG_SETUP_API_ID` / `TG_SETUP_API_HASH` в `.env` прода
- [ ] Проверить полный путь на живом клиенте, потом открыть продажу
