...
| `{stream_url}` | ссылка эфира дня: при внешнем эфире — Zoom/YouTube |
| `{webinar_room_url}` | **наша** комната дня — ВСЕГДА, даже когда эфир внешний (`day_room_url` в [webinar_service.py](backend/app/services/webinar_service.py)). Спикеру нужны обе ссылки сразу |
